...
import 'package:flutter/material.dart';
import 'package:nueva_app_web_matematicas/ESTUDIANTES/Dashboard_Estudiante/dashboard_estudiante.dart';
import 'package:nueva_app_web_matematicas/ESTUDIANTES/Lista_Temarios_Cuestionarios_Estudiantes/Lista_Temarios_Cuestionarios_Estudiantes.dart';
import 'package:nueva_app_web_matematicas/ESTUDIANTES/Lista_Temarios_Examenes_Estudiantes/ListaTemariosExamenesEstudiantes.dart';

class SeleccionNotasEstudiantes extends StatefulWidget {
  final String userId;

  SeleccionNotasEstudiantes({Key? key, required this.userId}) : super(key: key);

  @override
  _SeleccionNotasEstudiantesScreenState createState() => _SeleccionNotasEstudiantesScreenState();
}

class _SeleccionNotasEstudiantesScreenState extends State<SeleccionNotasEstudiantes> {
  bool _isHoveringCuestionarios = false;
  bool _isHoveringExamenes = false;
          ...
          child: Row(
            ...
            children: <Widget>[
              _buildOptionButton(
                'Cuestionarios',
                'images/boleta-de-calificaciones.png',
                ListaTemariosCuestionariosEstudiantes(idUsuario: widget.userId),
                //NotasCuestionarioEstudiante(idUsuario: widget.userId),
              ),
              SizedBox(width: 20),
              _buildOptionButton(
                'Exámenes',
                'images/certificado.png',
                ListaTemariosExamenesEstudiantes(idUsuario: widget.userId),
                //NotasExamenEstudiante(idUsuario: widget.userId),
              ),
            ],
          ),
