...
class ListaTemariosExamenesEstudiantes extends StatefulWidget {
  final String idUsuario;

  ListaTemariosExamenesEstudiantes({required this.idUsuario});
  @override
  _ListaTemariosExamenesEstudiantesState createState() => _ListaTemariosExamenesEstudiantesState();
}

class _ListaTemariosExamenesEstudiantesState extends State<ListaTemariosExamenesEstudiantes> {
                                                        ...
                                                        ListTile(
                                                          ...
                                                          onTap: () {
                                                            Navigator.push(
                                                              context,
                                                              MaterialPageRoute(
                                                                builder: (context) => NotasExamenEstudiante(
                                                                  idUsuario: widget.idUsuario,
                                                                  idExamen: examenDoc.id, // Pasar el ID del examen
                                                                ),
                                                              ),
                                                            );
                                                          },
